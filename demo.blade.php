...
<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <a href="{{route('guitar')}}" class="logo d-flex align-items-center">


             <img src="assets/img/logo.jpg" alt="">
            <h1 class="d-flex align-items-center">Glorious Music Classes</h1>
        </a>
...
<section id="hero" class="hero d-flex align-items-center">
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
                <h2 data-aos="fade-up">Focus On What Inspire's You</h2>
                <blockquote data-aos="fade-up" data-aos-delay="100">
                    <p>Music is a form of art that uses sound organised in time. Music is also a form of entertainment that puts sounds together in a way that people like, find interesting or dance to</p>
                </blockquote>
                <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                    <a href="#about" class="btn-get-started">Register Now!</a>
                    <a href="https://youtu.be/7upKRUSQXw8" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
                </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                        <h4 class="title"><a href="#" class="stretched-link">Guitar</a></h4>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <div class="icon-list d-flex">
                                ...
                                <span>We Train You For your Grades</span>
                            </div>
                        </div><!-- End Icon List Item-->
